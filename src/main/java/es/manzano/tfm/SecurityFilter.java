...
public class SecurityFilter  {
	...
	// LogManager.getLogger("es.manzano.tfm.SecurityFilter");
	...
	public static void filter(String sessionId, String userId, String addr, String previous, String current,
			String tokenprevious, String tokencurrent) throws FilterException {
	...
	public static void doFilter(HttpServletRequest request, HttpServletResponse response, boolean csfrToken)
			throws Exception {
		...
		for (Cookie cookie : cookies) {
			if (cookie.getName().equalsIgnoreCase("usuario"))
				userId = cookie.getValue();
		}
		if (userId == null || userId.trim().equalsIgnoreCase(""))
			userId = SecurityFilter.NO_USER;
	...
	public static void doFilterLoginSuccess(HttpServletRequest request, HttpServletResponse response, boolean csfrToken)
			throws Exception {
